...
<script>
   $(function(){
      ...
      $('#lang').on('change', function(){
         ...
         console.log(document.location="/jstl/jstl_fmt.jsp?lang=" + $('#lang').val());
...
<body>
   ...
   <!-- 
      사용할 리소스 번들 설정 (리소스번들명_locale.properties) 
      kr.or.ddit.resourse.message_locale.properties 
   -->
   <%
   ...
   <h3>setBundle</h3>
   <!-- setBundle : 번들 메세지를 변수에 저장하여 message 태그에서 사용하게 끔 하는 태그 -->
