  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="<%=request.getContextPath()%>/login" method="POST">
        ...
        <input type="email" id="email" name="userId" class="form-control" placeholder="Email address" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="namepassword" name="password" class="form-control" placeholder="Password" required>
        <div class="checkbox">
          <label>
